...
import org.hisrc.tenet.model.RailwayNode.Properties;
...
public class RailwayNode extends Feature<Point, double[], Properties> {
...
//			Validate.notNull(geographicalName);
		...
		public String toString() {
			return "RailwayNode [" + id + (geographicalName == null ? "" : (" (" + geographicalName + ")")) + "].";
		}
